...
export default function EnjoyResponsibleBoatingShort() {
	const {textLabels} = useTextLabels();
	const {locale} = useTranslation();

	return (
		<section className="section section_p0">
			<div className="container">
				<div className="text-block text-block_propulsion text-block_propulsion_inner">
					<div className=" flex flex_sb_c flex_sm_column flex_sm_fs-s">
						...
						<div className="text-block__content">
							<div className="detailed">
								<ul className="detailed__list flex flex_column flex_sm_row flex_sm_sb-c">
